...
const bikes = [
  {
    ...
    category: 'Automática',
    image: resolveImageUrl('/matrix1.png'),
    images: [resolveImageUrl('/matrix1.png'), resolveImageUrl('/matrix2.png')],
    price: '$1,380',
    hp: '8.71 HP',
    cc: '150 CC',
  ...
  },
  {
    ...
    name: 'EK Xpress 150',
    category: 'Sincrónica',
    image: resolveImageUrl('/xpress1.png'),
    images: [resolveImageUrl('/xpress1.png'), resolveImageUrl('/xpress2.png')],
    price: '$1,200',
    hp: '12.3 HP',
    cc: '149 CC',
  ...
  },
  {
    ...
    name: 'EK Owen 150 (GS)',
    category: 'Sincrónica',
    image: resolveImageUrl('/owen1.png'),
    images: [resolveImageUrl('/owen1.png'), resolveImageUrl('/owen2.png')],
    price: '$1,300',
    hp: '12.3 HP',
    cc: '150 CC',
